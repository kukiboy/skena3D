    ...
    (function (Items) {
        ...
        class Item extends THREE.Mesh {
            ...
            clickPressed(intersection) {
                ...
                console.log("551 this.dragOffset.copy");
            }
            ;
            /** */
            clickDragged(intersection) {
                if (intersection) {
                  var intersections;
                    ...
                    console.log("558 belki burda da snap to grid yapilabili");
                }
            }
            ;
            /** */
...
(function (BP3D) {
    ...
    (function (Three) {
        ...
        Three.HUD = function (three) {
            ...
            //ketu resetohet objekti i perzgjedhur
            ...
            // ketu krijohet shenja e kursorit per rrotullim
            function itemSelected(item) {
                if (selectedItem != item) {
                  ...
                  // //selectedItem = item;
                  // control.attach( item );
                  // console.log( "ok " + activeObject);


                  //makeObject(selectedItem);
                  //scene.add( control );
            ...
            // ketu pergaditet krijimi i 3D kursorit per rotullim
...
console.log("EloniCAD " + BP3D.Core.Version.getInformalVersion()

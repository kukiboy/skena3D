...
var SideMenu = function(blueprint3d, floorplanControls, modalEffects) {
  ...
  function handleWindowResize() {
    ...
    $("#add-elements").height(window.innerHeight);
    $("#use-curtains").height(window.innerHeight);
    $("#use-ttools").height(window.innerHeight);
    $("#use-osystem").height(window.innerHeight);
    $("#share-smedia").height(window.innerHeight);
  };
  ...
  function initElements() {
    $("#add-elements").find(".add-item").mousedown(function(e) {
      var modelUrl = $(this).attr("model-url");
      var itemType = parseInt($(this).attr("model-type"));
      var metadata = {
        itemName: $(this).attr("model-name"),
